module constant_in_the_simulation
    ...
    integer, parameter :: parallel_grid_number = 1000    !for a(parallel) (adiabatic_invariant_grid_number >= parallel_grid_number)
    ...
    double precision, parameter :: alpha_lightspeed = 5d-1
