module constant_in_the_simulation
    ...
    integer, parameter :: adiabatic_invariant_grid_number = 512    !for adiabatic invariant
    integer, parameter :: parallel_grid_number = 512    !for a(parallel) (adiabatic_invariant_grid_number >= parallel_grid_number)
