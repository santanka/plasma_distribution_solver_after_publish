module reference_results_setting
    ...
    &'alpha_perp_12_parallel_12/grid_014_109_175/boundary_condition_16/number_density_iteration/min_167.csv'
    integer, parameter :: boundary_series_number = 12
    integer, parameter :: plot_grid_number = 247
    ...
    character(len=7), parameter :: result_file_middle_3 = '_alpha_'
