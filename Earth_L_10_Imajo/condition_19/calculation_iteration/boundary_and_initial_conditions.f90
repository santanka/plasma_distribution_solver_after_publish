module boundary_and_initial_conditions
    ...
    integer, parameter :: initial_grid_ionophere_middle_1 = 29
    ...
    double precision, parameter :: initial_electrostatic_potential_ionosphere = 3.5d3     ![V] = [kg m2 s-3 A-1]
    ...
    integer, parameter :: boundary_file_number = 19  !boundary_file
    integer, parameter :: boundary_series_number = 12
    integer, parameter :: boundary_ionosphere_1_variable_species = 3
    integer, parameter :: boundary_ionosphere_2_variable_species = 7
    integer, parameter :: boundary_magnetosphere_variable_species = 9
